            ...
            <div className="card-header">
              <nav className="header-navigation">
                ...
                <div className="btn-group">
                  <a href="#" className="btn btn-link btn-share">
                    Share
                  </a>
                  <a href="#" className="btn btn-link">
                    Sell item like this
            ...
            <div className="card-body store-body">
              <div className="product-info">
                <div className="product-gallery">
                  <div className="product-gallery-thumbnails"></div>
                ...
                <div className="product-seller-recommended">
                  <div className="product-description mb-5">
                    ...
                    <dl className="row mb-5">
                      ...
                      <dd className="col-sm-9">{this.state.title}</dd>
                      <dt className="col-sm-3">Type</dt>
                      <dd className="col-sm-9">{this.state.type}</dd>
                      <dt className="col-sm-3">Suited for</dt>
              ...
              <div className="product-payment-details">
                <p className="last-sold text-muted">
                  <small>05 items left in stock</small>
                </p>
                <h4 className="product-title mb-2">
                  {this.state.title + " " + this.state.details}
                </h4>
                <h2 className="product-price display-4">
                  ₹ {this.state.price}.00
                </h2>
                <p className="text-success">
                  <i className="fa fa-credit-card"></i> Up to 12 installments
                </p>
                <p className="mb-0">
                  <i className="fa fa-truck"></i> 2-day delivery anywhere in
                  India
                </p>
                <div className="text-muted mb-2">
                  <small>
                    Find out more about delivery time and shipping forms
                  </small>
                </div>
                ...
                <input
                  ...
                  min="1"
                  id="quant"
                  className="form-control mb-5 input-lg"
